...
const PLUGIN_PROPS = {
  ...
  zoomMax: { label: 'data-zoom-max', value: 5, isRequired: false },
  zoomControls: { label: 'data-zoom-controls', isRequired: false },
  pinchZoom: { label: 'data-pinch-zoom', isRequired: false },
