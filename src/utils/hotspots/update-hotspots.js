...
export const updateHotspots = (
  ...
  hotspotsProps.forEach((hotspotProps) => {
    const { positions, initialDimensions, orientation, variant } = hotspotProps;
    ...
    const currentPosition = hotspotsPositions.find(
      (hotspotPosition) => hotspotPosition.imageIndex === currentImageIndex
    );
