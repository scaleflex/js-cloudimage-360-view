const get360ViewProps = (image) => ({
  ...
  filename: attr(image, 'filename') || attr(image, 'data-filename') || attr(image, 'data-filename-x') || 'image-{index}.jpg',
  filenameY: attr(image, 'filenameY') || attr(image, 'data-filename-y'),
  ...
  amountY: parseInt(attr(image, 'amount-y') || attr(image, 'data-amount-y') || 36, 10),
  ...
  spinY: isTrue(image, 'autoplay-spinY'),
  spinXY: isTrue(image, 'autoplay-spinXY'),
