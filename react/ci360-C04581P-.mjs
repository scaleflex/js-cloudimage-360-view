...
var wi = (e, t, i) => t in e ? bi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i;
var ye = (e, t, i) => wi(e, typeof t != "symbol" ? t + "" : t, i);
var Dt = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Ci(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var ti = "Expected a function", be = NaN, Ii = "[object Symbol]", xi = /^\s+|\s+$/g, Oi = /^[-+]0x[0-9a-f]+$/i, Ei = /^0b[01]+$/i, ki = /^0o[0-7]+$/i, Ai = parseInt, Si = typeof Dt == "object" && Dt && Dt.Object === Object && Dt, Li = typeof self == "object" && self && self.Object === Object && self, Ti = Si || Li || Function("return this")(), Pi = Object.prototype, Mi = Pi.toString, Ri = Math.max, Xi = Math.min, Qt = function() {
  return Ti.Date.now();
};
function Yi(e, t, i) {
  ...
  t = we(t) || 0, Vt(i) && (c = !!i.leading, u = "maxWait" in i, n = u ? Ri(we(i.maxWait) || 0, t) : n, f = "trailing" in i ? !!i.trailing : f);
  function m(p) {
    var y = o, I = s;
    return o = s = void 0, h = p, l = e.apply(I, y), l;
  }
  function C(p) {
    return h = p, a = setTimeout(x, t), c ? m(p) : l;
  }
  function b(p) {
    var y = p - r, I = p - h, k = t - y;
    return u ? Xi(k, n - I) : k;
  }
  function v(p) {
    var y = p - r, I = p - h;
    return r === void 0 || y >= t || y < 0 || u && I >= n;
  }
  function x() {
    var p = Qt();
    if (v(p))
  ...
  function E(p) {
    return a = void 0, f && o ? m(p) : (o = s = void 0, l);
  }
  function w() {
  ...
  function O() {
    var p = Qt(), y = v(p);
    if (o = arguments, s = this, r = p, y) {
      if (a === void 0)
        return C(r);
      if (u)
        return a = setTimeout(x, t), m(r);
    }
...
function Hi(e, t, i) {
  ...
  if (typeof e != "function")
    throw new TypeError(ti);
  return Vt(i) && (o = "leading" in i ? !!i.leading : o, s = "trailing" in i ? !!i.trailing : s), Yi(e, t, {
    leading: o,
    maxWait: t,
    trailing: s
  });
...
function Di(e) {
  return typeof e == "symbol" || Zi(e) && Mi.call(e) == Ii;
}
function we(e) {
  if (typeof e == "number")
    return e;
  ...
  e = e.replace(xi, "");
  var i = Ei.test(e);
  return i || ki.test(e) ? Ai(e.slice(2), i ? 2 : 8) : Oi.test(e) ? be : +e;
}
var Bi = Hi;
const Ce = /* @__PURE__ */ Ci(Bi), Y = {
  SPIN_X: "spin-x",
  SPIN_Y: "spin-y",
  SPIN_XY: "spin-xy",
  SPIN_YX: "spin-yx"
}, Fi = [!1, 0, null, void 0, "false", "0", "null", "undefined"], R = {
  X: "x-axis",
  Y: "y-axis"
}, Wi = [37, 39], Ni = [38, 40], Vi = typeof navigator < "u" && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), Ie = Vi ? 32 : 10, $i = 150, Bt = 800, zi = 150, ji = 200, xe = 50, Gi = 50, _i = 5, Oe = 5, d = {
  folder: "/",
  apiVersion: "v7",
  ...
  const s = S(e, t, null);
  return s !== "false" && s !== "0";
}, Ft = (e, t) => S(e, t, null) === "false", Ji = (e = 1) => {
  const t = Math.round(window.devicePixelRatio || 1);
  return parseInt(e) * t;
}, Qi = (e, t, i) => new URL(e).origin.includes("cloudimg") ? e : `https://${t}.cloudimg.io/${i}${e}`, Ee = (e, t) => e ? `ar=${e}&gravity=${t || "auto"}` : "", to = ({ ciTransformation: e, responsiveWidth: t, ciFilters: i }) => {
  const o = `width=${t}`, s = e || o, n = i ? `&f=${i}` : "";
  return `${s}${n}`;
}, Ct = (e, t) => {
  const { folder: i, apiVersion: o, filename: s = "", ciParams: n } = e, { ciToken: l, ciFilters: a, ciTransformation: r, cropAspectRatio: h, cropGravity: c } = n || {}, u = `${i}${s}`;
  if (!l || !t) {
    const w = Ee(h, c);
    if (!w) return u;
    const g = u.includes("?") ? "&" : "?";
  ...
  const f = Fi.includes(o) ? null : o, m = f ? `${f}/` : "", C = Ji(t), b = Qi(u, l, m), v = to({
    ciTransformation: r,
    responsiveWidth: C,
    ciFilters: a
...
}, io = (e, t) => eo(e, "width", t), ei = (e, t = 0) => (e += "", e.length >= t ? e : new Array(t - e.length + 1).join("0") + e), oo = (e, { amount: t = 0, indexZeroBase: i = 0 } = {}) => Array.from({ length: t }, (o, s) => e.replace("{index}", ei(s + 1, i))), so = typeof navigator < "u" && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), no = so ? 3 : 6, ro = ({
  imagesUrls: e,
  onFirstImageLoad: t,
  onImageLoad: i,
  onAllImagesLoad: o,
  ...
  const m = [], C = (p, y, I = !1) => {
    ...
    u++;
    const I = new Image();
    I.crossOrigin = "anonymous", I.src = p, I.onload = async () => {
      try {
        ...
        I.onload = null, I.onerror = null, I.src = "", l++, u--, h[y] = A, i == null || i(A, y), b(), v();
      } catch {
        I.onload = null, I.onerror = null, I.src = "", l++, u--, C(p, y), b(), v();
      }
    }, I.onerror = () => {
      I.onload = null, I.onerror = null, I.src = "", l++, u--, C(p, y), b(), v();
    };
  ...
  w.crossOrigin = "anonymous", w.src = O, w.onload = async () => {
    try {
      const p = await createImageBitmap(w), y = {
        src: O,
        bitmapImage: p,
  ...
  const m = e || i.imageList.length, C = t || o.imageList.length, b = () => {
    if (r.x && r.y) {
      const x = {
  ...
  }, v = ({ cdnPath: x, config: E, orientation: w, loadedImages: g, loadStats: O, onFirstImageLoad: p }) => {
    const y = w === R.X, I = E.imageList.length ? E.imageList : oo(x, E);
    ro({
      imagesUrls: I,
      onFirstImageLoad: p,
      onImageLoad: (k, A) => {
      ...
      onAllImagesLoad: (k, A) => {
        g.length = 0, k.forEach((L, X) => {
          L && (g[X] = L);
        }), O.errorCount = A.errorCount, O.errors = A.errors.map((L) => ({ ...L, orientation: w })), r[y ? "x" : "y"] = !0, b();
      },
...
`, ho = (e) => {
...
}, ii = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 3 21 3 21 9"/><polyline points="9 21 3 21 3 15"/><line x1="21" x2="14" y1="3" y2="10"/><line x1="3" x2="10" y1="21" y2="14"/></svg>', po = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="4 14 10 14 10 20"/><polyline points="20 10 14 10 14 4"/><line x1="14" x2="21" y1="10" y2="3"/><line x1="3" x2="10" y1="21" y2="14"/></svg>', mo = () => {
  const e = document.createElement("button");
  return e.className = "cloudimage-360-button cloudimage-360-fullscreen-button", e.setAttribute("aria-label", "View fullscreen"), e.setAttribute("type", "button"), e.innerHTML = ii, e;
}, fo = (e, t) => {
  e && (e.innerHTML = t ? po : ii, e.setAttribute("aria-label", t ? "Exit fullscreen" : "View fullscreen"));
}, Ae = (e) => {
  const t = document.createElement("div");
  ...
  return s.className = "cloudimage-360-hints-container", t.forEach((n) => {
    oi[n] && s.appendChild(Eo(n, i));
  }), o.appendChild(s), e.appendChild(o), o;
}, Te = (e, t) => t ? ["swipe", "pinch"] : ["drag", "click"], Pe = (e) => {
  ...
  const t = Yo(e, "width"), i = t.includes("?") ? "&" : "?";
  ...
  const { innerBox: o, imageList: s, lazyload: n } = t || {}, [l] = s, a = l || Fo(e, t), r = Ho(a), h = Me(r, n, "cloudimage-lazy"), c = Me(r, !1, "cloudimage-360-placeholder"), u = (f) => {
  ...
  h.onload = u, o.appendChild(h), o.appendChild(c), Zo(h);
}, Wo = (e, t, i) => {
  const o = new Image();
  o.src = e, o.onload = (s) => {
    t && t({
  ...
  const { container: o, w: s, h: n, zoom: l, bw: a, offsetX: r, offsetY: h } = t, c = No(e, o);
  let u = c.x, f = c.y;
  ...
  const m = (u - r) * l - s + a, C = (f - h) * l - n + a;
  i.style.backgroundPosition = `-${m}px -${C}px`;
}, Vo = (e, t, i, o, s, n) => {
  ...
  const c = 3, u = s.offsetWidth / 2, f = s.offsetHeight / 2, m = {
    container: t,
    w: u,
    h: f,
    zoom: n,
  ...
  e ? t() : i();
}, Go = ({ autoplayBehavior: e, spinY: t, reversed: i, loopTriggers: o }) => {
  switch (e) {
    case Y.SPIN_XY:
    case Y.SPIN_YX:
      t ? Xe(i, o) : Ye(i, o);
  ...
  return e === Y.SPIN_XY || e === Y.SPIN_YX ? l === "x" && a || l === "y" && r : !1;
}, Ko = (e, t, i) => {
  if (!i) return "x";
  if (!t) return "y";
  switch (e) {
...
}, Jo = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0, Qo = (e, t = 150) => {
  let i;
  return function(...o) {
...
class ss {
  ...
  drawImageOnCanvas(t = {}, i = 1, o = 0, s = 0) {
    ...
    if (this.wideImage ? (l = 0, a = (this.canvas.height / this.dpr - this.drawHeight) / 2) : (l = (this.canvas.width / this.dpr - this.drawWidth) / 2, a = 0), this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height), i !== 1) {
      const { naturalWidth: r, naturalHeight: h } = t, { zoomedWidth: c, zoomedHeight: u } = zo(r, h, i), { zoomOffsetX: f, zoomOffsetY: m } = jo({
        pointerX: o,
        pointerY: s,
        imageData: t,
        zoomedWidth: c,
...
}, ls = (e) => e === "y" ? R.Y : R.X, cs = (e, t, i) => e.filter(
...
var H = "top", W = "bottom", N = "right", Z = "left", re = "auto", kt = [H, W, N, Z], ut = "start", Ot = "end", ys = "clippingParents", ni = "viewport", wt = "popper", bs = "reference", Ne = /* @__PURE__ */ kt.reduce(function(e, t) {
  return e.concat([t + "-" + ut, t + "-" + Ot]);
}, []), ri = /* @__PURE__ */ [].concat(kt, [re]).reduce(function(e, t) {
  return e.concat([t, t + "-" + ut, t + "-" + Ot]);
}, []), ws = "beforeRead", Cs = "read", Is = "afterRead", xs = "beforeMain", Os = "main", Es = "afterMain", ks = "beforeWrite", As = "write", Ss = "afterWrite", Ls = [ws, Cs, Is, xs, Os, Es, ks, As, Ss];
function z(e) {
...
function Ts(e) {
  ...
  Object.keys(t.elements).forEach(function(i) {
    ...
    !F(n) || !z(n) || (Object.assign(n.style, o), Object.keys(s).forEach(function(l) {
      var a = s[l];
...
function Ps(e) {
  ...
  return Object.assign(t.elements.popper.style, i.popper), t.styles = i, t.elements.arrow && Object.assign(t.elements.arrow.style, i.arrow), function() {
    Object.keys(t.elements).forEach(function(o) {
      ...
      !F(s) || !z(s) || (Object.assign(s.style, a), Object.keys(n).forEach(function(r) {
        s.removeAttribute(r);
      }));
    });
  };
...
var it = Math.max, $t = Math.min, pt = Math.round;
function se() {
...
function mt(e, t, i) {
  ...
  t && F(e) && (s = e.offsetWidth > 0 && pt(o.width) / e.offsetWidth || 1, n = e.offsetHeight > 0 && pt(o.height) / e.offsetHeight || 1);
  var l = ot(e) ? B(e) : window, a = l.visualViewport, r = !ai() && i, h = (o.left + (r && a ? a.offsetLeft : 0)) / s, c = (o.top + (r && a ? a.offsetTop : 0)) / n, u = o.width / s, f = o.height / n;
  return {
    width: u,
    height: f,
    top: c,
...
function Xs(e) {
  ...
  var s = zt(e);
  for (ae(s) && (s = s.host); F(s) && ["html", "body"].indexOf(z(s)) < 0; ) {
    var n = q(s);
...
function At(e) {
  for (var t = B(e), i = Ve(e); i && Rs(i) && q(i).position === "static"; )
    i = Ve(i);
  return i && (z(i) === "html" || z(i) === "body" && q(i).position === "static") ? t : i || Xs(e) || t;
}
function ce(e) {
...
var Hs = function(t, i) {
  ...
  })) : t, hi(typeof t != "number" ? t : di(t, kt));
};
function Zs(e) {
  var t, i = e.state, o = e.name, s = e.options, n = i.elements.arrow, l = i.modifiersData.popperOffsets, a = $(i.placement), r = ce(a), h = [Z, N].indexOf(a) >= 0, c = h ? "height" : "width";
  if (!(!n || !l)) {
    var u = Hs(s.padding, i), f = le(n), m = r === "y" ? H : Z, C = r === "y" ? W : N, b = i.rects.reference[c] + i.rects.reference[r] - l[r] - i.rects.popper[c], v = l[r] - i.rects.reference[r], x = At(n), E = x ? r === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = b / 2 - v / 2, g = u[m], O = E - f[c] - u[C], p = E / 2 - f[c] / 2 + w, y = It(g, p, O), I = r;
    i.modifiersData[o] = (t = {}, t[I] = y, t.centerOffset = y - p, t);
  }
}
function Ds(e) {
  var t = e.state, i = e.options, o = i.element, s = o === void 0 ? "[data-popper-arrow]" : o;
  s != null && (typeof s == "string" && (s = t.elements.popper.querySelector(s), !s) || li(t.elements.popper, s) && (t.elements.arrow = s));
}
const Bs = {
  name: "arrow",
  enabled: !0,
...
function $e(e) {
  var t, i = e.popper, o = e.popperRect, s = e.placement, n = e.variation, l = e.offsets, a = e.position, r = e.gpuAcceleration, h = e.adaptive, c = e.roundOffsets, u = e.isFixed, f = l.x, m = f === void 0 ? 0 : f, C = l.y, b = C === void 0 ? 0 : C, v = typeof c == "function" ? c({
    x: m,
    y: b
  }) : {
    x: m,
  ...
  m = v.x, b = v.y;
  var x = l.hasOwnProperty("x"), E = l.hasOwnProperty("y"), w = Z, g = H, O = window;
  if (h) {
    var p = At(i), y = "clientHeight", I = "clientWidth";
    if (p === B(i) && (p = Q(i), q(p).position !== "static" && a === "absolute" && (y = "scrollHeight", I = "scrollWidth")), p = p, s === H || (s === Z || s === N) && n === Ot) {
      g = W;
      var k = u && p === O && O.visualViewport ? O.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        p[y]
      );
    ...
    if (s === Z || (s === H || s === W) && n === Ot) {
      w = N;
      var A = u && p === O && O.visualViewport ? O.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        p[I]
      );
      m -= A - o.width, m *= r ? 1 : -1;
  ...
  if (m = X.x, b = X.y, r) {
    var T;
    return Object.assign({}, L, (T = {}, T[g] = E ? "0" : "", T[w] = x ? "0" : "", T.transform = (O.devicePixelRatio || 1) <= 1 ? "translate(" + m + "px, " + b + "px)" : "translate3d(" + m + "px, " + b + "px, 0)", T));
  }
  return Object.assign({}, L, (t = {}, t[g] = E ? b + "px" : "", t[w] = x ? m + "px" : "", t.transform = "", t));
}
function Ns(e) {
  ...
  t.modifiersData.popperOffsets != null && (t.styles.popper = Object.assign({}, t.styles.popper, $e(Object.assign({}, h, {
    offsets: t.modifiersData.popperOffsets,
    position: t.options.strategy,
    adaptive: l,
    roundOffsets: r
  })))), t.modifiersData.arrow != null && (t.styles.arrow = Object.assign({}, t.styles.arrow, $e(Object.assign({}, h, {
...
function $s(e) {
  ...
  return n && h.forEach(function(c) {
    c.addEventListener("scroll", i.update, Wt);
  }), a && r.addEventListener("resize", i.update, Wt), function() {
    n && h.forEach(function(c) {
      c.removeEventListener("scroll", i.update, Wt);
...
function ui(e) {
  return ["html", "body", "#document"].indexOf(z(e)) >= 0 ? e.ownerDocument.body : F(e) && ue(e) ? e : ui(zt(e));
}
function xt(e, t) {
  var i;
  t === void 0 && (t = []);
  var o = ui(e), s = o === ((i = e.ownerDocument) == null ? void 0 : i.body), n = B(o), l = s ? [n].concat(n.visualViewport || [], ue(o) ? o : []) : o, a = t.concat(l);
  return s ? a : (
...
function je(e, t, i) {
  return t === ni ? ne(_s(e, i)) : ot(t) ? Ks(t, i) : ne(Us(Q(e)));
}
function qs(e) {
  var t = xt(zt(e)), i = ["absolute", "fixed"].indexOf(q(e).position) >= 0, o = i && F(e) ? At(e) : e;
  return ot(o) ? t.filter(function(s) {
    return ot(s) && li(s, o) && z(s) !== "body";
  }) : [];
}
function Js(e, t, i, o) {
  var s = t === "clippingParents" ? qs(e) : [].concat(t), n = [].concat(s, [i]), l = n[0], a = n.reduce(function(r, h) {
    var c = je(e, h, o);
    return r.top = it(c.top, r.top), r.right = $t(c.right, r.right), r.bottom = $t(c.bottom, r.bottom), r.left = it(c.left, r.left), r;
  }, je(e, l, o));
  return a.width = a.right - a.left, a.height = a.bottom - a.top, a.x = a.left, a.y = a.top, a;
}
function pi(e) {
  var t = e.reference, i = e.element, o = e.placement, s = o ? $(o) : null, n = o ? ft(o) : null, l = t.x + t.width / 2 - i.width / 2, a = t.y + t.height / 2 - i.height / 2, r;
  switch (s) {
    case H:
      r = {
        x: l,
...
function Et(e, t) {
  t === void 0 && (t = {});
  var i = t, o = i.placement, s = o === void 0 ? e.placement : o, n = i.strategy, l = n === void 0 ? e.strategy : n, a = i.boundary, r = a === void 0 ? ys : a, h = i.rootBoundary, c = h === void 0 ? ni : h, u = i.elementContext, f = u === void 0 ? wt : u, m = i.altBoundary, C = m === void 0 ? !1 : m, b = i.padding, v = b === void 0 ? 0 : b, x = hi(typeof v != "number" ? v : di(v, kt)), E = f === wt ? bs : wt, w = e.rects.popper, g = e.elements[C ? E : f], O = Js(ot(g) ? g : g.contextElement || Q(e.elements.popper), r, c, l), p = mt(e.elements.reference), y = pi({
    reference: p,
    element: w,
    placement: s
  }), I = ne(Object.assign({}, w, y)), k = f === wt ? I : p, A = {
  ...
  if (f === wt && L) {
    ...
    Object.keys(A).forEach(function(T) {
      var j = [N, W].indexOf(T) >= 0 ? 1 : -1, G = [H, W].indexOf(T) >= 0 ? "y" : "x";
      A[T] += X[G] * j;
    });
  }
  return A;
...
function Qs(e, t) {
  t === void 0 && (t = {});
  var i = t, o = i.placement, s = i.boundary, n = i.rootBoundary, l = i.padding, a = i.flipVariations, r = i.allowedAutoPlacements, h = r === void 0 ? ri : r, c = ft(o), u = c ? a ? Ne : Ne.filter(function(C) {
    return ft(C) === c;
  }) : kt, f = u.filter(function(C) {
    return h.indexOf(C) >= 0;
  });
  f.length === 0 && (f = u);
  var m = f.reduce(function(C, b) {
    return C[b] = Et(e, {
      placement: b,
      boundary: s,
      rootBoundary: n,
...
function en(e) {
  ...
  if (!t.modifiersData[o]._skip) {
    for (var s = i.mainAxis, n = s === void 0 ? !0 : s, l = i.altAxis, a = l === void 0 ? !0 : l, r = i.fallbackPlacements, h = i.padding, c = i.boundary, u = i.rootBoundary, f = i.altBoundary, m = i.flipVariations, C = m === void 0 ? !0 : m, b = i.allowedAutoPlacements, v = t.options.placement, x = $(v), E = x === v, w = r || (E || !C ? [Nt(v)] : tn(v)), g = [v].concat(w).reduce(function(J, V) {
      return J.concat($(V) === re ? Qs(t, {
        placement: V,
        boundary: c,
        rootBoundary: u,
        padding: h,
    ...
    }, []), O = t.rects.reference, p = t.rects.popper, y = /* @__PURE__ */ new Map(), I = !0, k = g[0], A = 0; A < g.length; A++) {
      var L = g[A], X = $(L), T = ft(L) === ut, j = [H, W].indexOf(X) >= 0, G = j ? "width" : "height", P = Et(t, {
        placement: L,
        boundary: c,
        rootBoundary: u,
        altBoundary: f,
      ...
      O[G] > p[G] && (D = Nt(D));
      var st = Nt(D), _ = [];
      if (n && _.push(P[X] <= 0), a && _.push(P[D] <= 0, P[st] <= 0), _.every(function(J) {
        return J;
      })) {
        k = L, I = !1;
        break;
    ...
    if (I)
      for (var nt = C ? 3 : 1, vt = function(V) {
        var et = g.find(function(at) {
          var U = y.get(at);
          if (U)
            return U.slice(0, V).every(function(lt) {
              return lt;
            });
        });
        if (et)
...
function _e(e) {
  return [H, N, W, Z].some(function(t) {
    return e[t] >= 0;
  });
}
function sn(e) {
  var t = e.state, i = e.name, o = t.rects.reference, s = t.rects.popper, n = t.modifiersData.preventOverflow, l = Et(t, {
    ...
    altBoundary: !0
  }), r = Ge(l, o), h = Ge(a, s, n), c = _e(r), u = _e(h);
  t.modifiersData[i] = {
...
function rn(e, t, i) {
  var o = $(e), s = [Z, H].indexOf(o) >= 0 ? -1 : 1, n = typeof i == "function" ? i(Object.assign({}, t, {
    placement: e
  })) : i, l = n[0], a = n[1];
  return l = l || 0, a = (a || 0) * s, [Z, N].indexOf(o) >= 0 ? {
    x: a,
    y: l
  } : {
    x: l,
...
function an(e) {
  var t = e.state, i = e.options, o = e.name, s = i.offset, n = s === void 0 ? [0, 0] : s, l = ri.reduce(function(c, u) {
    return c[u] = rn(u, t.rects, n), c;
...
function un(e) {
  var t = e.state, i = e.options, o = e.name, s = i.mainAxis, n = s === void 0 ? !0 : s, l = i.altAxis, a = l === void 0 ? !1 : l, r = i.boundary, h = i.rootBoundary, c = i.altBoundary, u = i.padding, f = i.tether, m = f === void 0 ? !0 : f, C = i.tetherOffset, b = C === void 0 ? 0 : C, v = Et(t, {
    boundary: r,
    rootBoundary: h,
    padding: u,
    altBoundary: c
  }), x = $(t.placement), E = ft(t.placement), w = !E, g = ce(x), O = dn(g), p = t.modifiersData.popperOffsets, y = t.rects.reference, I = t.rects.popper, k = typeof b == "function" ? b(Object.assign({}, t.rects, {
    placement: t.placement
  })) : b, A = typeof k == "number" ? {
    mainAxis: k,
    altAxis: k
    ...
    mainAxis: 0,
    altAxis: 0
  }, k), L = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, X = {
    x: 0,
    y: 0
  };
  if (p) {
    if (n) {
      var T, j = g === "y" ? H : Z, G = g === "y" ? W : N, P = g === "y" ? "height" : "width", D = p[g], st = D + v[j], _ = D - v[G], nt = m ? -I[P] / 2 : 0, vt = E === ut ? y[P] : I[P], tt = E === ut ? -I[P] : -y[P], rt = t.elements.arrow, J = m && rt ? le(rt) : {
        width: 0,
        height: 0
      }, V = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ci(), et = V[j], at = V[G], U = It(0, y[P], J[P]), lt = w ? y[P] / 2 - nt - U - et - A.mainAxis : vt - U - et - A.mainAxis, St = w ? -y[P] / 2 + nt + U + at + A.mainAxis : tt + U + at + A.mainAxis, ct = t.elements.arrow && At(t.elements.arrow), jt = ct ? g === "y" ? ct.clientTop || 0 : ct.clientLeft || 0 : 0, Lt = (T = L == null ? void 0 : L[g]) != null ? T : 0, Gt = D + lt - Lt - jt, _t = D + St - Lt, Tt = It(m ? $t(st, Gt) : st, D, m ? it(_, _t) : _);
      p[g] = Tt, X[g] = Tt - D;
    }
    if (a) {
      var Pt, Ut = g === "x" ? H : Z, Kt = g === "x" ? W : N, K = p[O], ht = O === "y" ? "height" : "width", Mt = K + v[Ut], Rt = K - v[Kt], gt = [H, Z].indexOf(x) !== -1, Xt = (Pt = L == null ? void 0 : L[O]) != null ? Pt : 0, Yt = gt ? Mt : K - y[ht] - I[ht] - Xt + A.altAxis, Ht = gt ? K + y[ht] + I[ht] - Xt - A.altAxis : Rt, Zt = m && gt ? Ys(Yt, K, Ht) : It(m ? Yt : Mt, K, m ? Ht : Rt);
      p[O] = Zt, X[O] = Zt - K;
    }
    t.modifiersData[o] = X;
  }
...
function gn(e, t, i) {
  i === void 0 && (i = !1);
  var o = F(t), s = F(t) && vn(t), n = Q(t), l = mt(e, s, i), a = {
    scrollLeft: 0,
    scrollTop: 0
  }, r = {
    x: 0,
  ...
  ue(n)) && (a = fn(t)), F(t) ? (r = mt(t, !0), r.x += t.clientLeft, r.y += t.clientTop) : n && (r.x = de(n))), {
...
function In(e) {
  e === void 0 && (e = {});
  var t = e, i = t.defaultModifiers, o = i === void 0 ? [] : i, s = t.defaultOptions, n = s === void 0 ? Ue : s;
  return function(a, r, h) {
    h === void 0 && (h = n);
    var c = {
      placement: "bottom",
      orderedModifiers: [],
      options: Object.assign({}, Ue, n),
      modifiersData: {},
      elements: {
        reference: a,
        popper: r
      ...
      setOptions: function(x) {
        ...
        var w = bn(Cn([].concat(o, c.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ke(E, w)) {
            c.rects = {
              reference: gn(E, At(w), c.options.strategy === "fixed"),
              popper: le(w)
            ...
            for (var g = 0; g < c.orderedModifiers.length; g++) {
              ...
              var O = c.orderedModifiers[g], p = O.fn, y = O.options, I = y === void 0 ? {} : y, k = O.name;
...
var xn = [zs, hn, Vs, Ms, ln, on, pn, Bs, nn], On = /* @__PURE__ */ In({
  defaultModifiers: xn
});
class En {
  /**
  ...
  constructor(t, i, o, s = {}) {
    ...
    this.container = i, this.popper = null, this.popperInstance = null, this.hotspotsContainer = Io(this.container), this.hotspotsConfig = ms(t), this.shouldHidePopper = !0, this.hidePopper = this.hidePopper.bind(this), this.forceHidePopper = this.forceHidePopper.bind(this), this.imageAspectRatio = o, this.hotspotElements = /* @__PURE__ */ new Map(), this.popperListeners = [], this.trigger = s.trigger || "hover", this.onOpen = s.onOpen || null, this.onClose = s.onClose || null, this.onProductClick = s.onProductClick || null;
  ...
  showPopper({ hotspotElement: t, content: i, id: o, keepOpen: s }) {
    ...
    this.popper = ps(i, o, this.container.parentElement), this.popper.setAttribute("data-show", ""), this.currentHotspotElement = t, t.setAttribute("aria-expanded", "true"), t.setAttribute("aria-describedby", `cloudimage-360-popper-${o}`);
    const l = () => {
    ...
    if (this.popper.addEventListener("mouseenter", l), this.popper.addEventListener("mouseleave", a), t.addEventListener("mouseleave", r), t.addEventListener("mouseenter", h), this.popperListeners.push(
      ...
      const u = this.onProductClick, f = (m) => {
        const C = m.target.closest(".ci360-popper-cta[data-product-id]");
        C && u(C.dataset.productId, o);
      };
  ...
  createHotspot(t) {
    const { id: i, keepOpen: o, onClick: s, label: n, markerStyle: l } = t, a = We(t), r = hs(i, n, l);
...
class Je {
  constructor(t, i) {
    ...
    this.devicePixelRatio = qe ? Math.min(o, 2) : o, this.id = t.id, this.movementStart = { x: 0, y: 0 }, this.draggingDirection = null, this.isReady = !1, this.velocityX = 0, this.velocityY = 0, this.lastDragTime = 0, this.lastDragX = 0, this.lastDragY = 0, this.inertiaAnimationId = null, this.hasInteracted = !1, this.currentZoomScale = 1, this.touchDevice = Jo(), this.dragJustEnded = !1, this.isPinching = !1, this.initialPinchDistance = 0, this.pinchZoomLevel = 1, this.pinchZoomEmitted = !1, this.lastEmittedZoom = 1, this.panOffsetX = 0, this.panOffsetY = 0, this.useMainThreadCanvas = qe, this.canvasWorker = this.useMainThreadCanvas ? new ss() : new os(), this.hotspotTimeline = null, this.hotspotTimelineIndicator = null, this.isAnimatingToFrame = !1, this.onMoveHandler = this.onMoveHandler.bind(this), this.destroy = this.destroy.bind(this), this.init(this.container, i);
  }
  /**
  ...
  startInertia() {
    const o = this.dragSpeed / xe, s = o * (this.amountX / this.container.offsetWidth), n = o * (this.amountY / this.container.offsetHeight), l = () => {
      if (this.velocityX *= 0.95, this.velocityY *= 0.95, Math.abs(this.velocityX) < 0.01 && Math.abs(this.velocityY) < 0.01) {
        this.inertiaAnimationId = null;
        return;
      }
      const a = this.velocityX * 16, r = this.velocityY * 16, h = Ze({
        deltaX: a,
        deltaY: r,
      ...
      if (h) {
        const c = this.allowSpinX ? Math.max(1, Math.abs(Math.round(a * s))) : 0, u = this.allowSpinY ? Math.max(1, Math.abs(Math.round(r * n))) : 0;
        (c > 0 || u > 0) && this.onMoveHandler(h, c, u);
      }
      this.inertiaAnimationId = requestAnimationFrame(l);
    };
    this.inertiaAnimationId = requestAnimationFrame(l);
  }
  drag(t, i) {
    ...
    const n = this.dragSpeed / xe, l = n * (this.amountX / this.container.offsetWidth), a = n * (this.amountY / this.container.offsetHeight), r = this.allowSpinX ? Math.abs(Math.round(o * l)) : 0, h = this.allowSpinY ? Math.abs(Math.round(s * a)) : 0;
    (this.allowSpinX && r !== 0 || this.allowSpinY && h !== 0) && (this.hasInteracted = !0, this.hideHotspotPopper(), this.onMoveHandler(this.draggingDirection, r, h), this.movementStart = { x: t, y: i }, setTimeout(() => {
  ...
  toggleZoom(t) {
    if (this.isZoomed)
      ...
      let i = (this.pointerZoom ? document.body : this.container).offsetWidth;
  ...
  applyZoom(t) {
    const { offsetX: i, offsetY: o } = $o(t, this.canvas, this.devicePixelRatio);
  ...
  onAllImagesLoaded() {
    if (this.addAllIcons(), this.isReady = !0, this.amountX = this.imagesX.length, this.amountY = this.imagesY.length, this.activeImageX = this.autoplayReverse ? this.amountX - 1 : 0, this.activeImageY = this.autoplayReverse ? this.amountY - 1 : 0, this.hotspots && (this.hotspotsInstance = new En(this.hotspots, this.innerBox, this.imageAspectRatio, {
      ...
      t && t.length > 0 && (this.hintsOverlay = Le(this.innerBox, t, {
        pointerZoomTrigger: this.pointerZoomTrigger
      }), Pe(this.hintsOverlay));
    }
    this.autoplay && (this.hideAllIcons(), Qo(this.play.bind(this))());
  }
  magnify(t) {
    t.stopPropagation();
    const { src: i } = this.orientation === R.Y ? this.imagesY[this.activeImageY] : this.imagesX[this.activeImageX], s = this.container.offsetWidth * this.magnifier, n = io(i, s);
    this.showLoadingSpinner(), this.createGlass(), Wo(n, (r) => {
      this.hideLoadingSpinner(), this.magnified = !0, Vo(t, this.innerBox, this.offset, r, this.glass, this.magnifier);
    }, (r) => {
  ...
  toggleFullscreen(t) {
    t.stopPropagation(), this.hideHotspotPopper(), ee() ? De() : es(this.container);
  }
  onFullscreenChange() {
    const t = ee() === this.container, i = this.container.classList.contains("cloudimage-360--fullscreen");
    t !== i && (this.container.classList.toggle("cloudimage-360--fullscreen", t), fo(this.fullscreenIcon, t), requestAnimationFrame(() => {
      this.imagesX.length > 0 && (this.adaptCanvasSize(this.imagesX[this.activeImageX]), this.updateView());
  ...
  addInitialIcon() {
    this.initialIcon || this.hide360Logo || (this.initialIcon = ho(this.logoSrc), this.innerBox.appendChild(this.initialIcon));
  }
  showInitialIcon() {
  ...
  addMagnifierIcon() {
    this.pointerZoom && (this.magnifierIcon = go(), this.magnifierIcon.onclick = this.zoomIn.bind(this), this.iconsContainer.appendChild(this.magnifierIcon), this.zoomOutIcon = yo(), this.zoomOutIcon.onclick = this.zoomOut.bind(this), this.zoomOutIcon.style.display = "none", this.iconsContainer.appendChild(this.zoomOutIcon));
  }
  showMagnifierIcon() {
  ...
  addFullscreenIcon() {
    !this.fullscreen || !ts() || (this.fullscreenIcon = mo(), this.fullscreenIcon.onclick = this.toggleFullscreen.bind(this), this.iconsContainer.appendChild(this.fullscreenIcon));
  }
  showFullscreenIcon() {
  ...
  addLoadingSpinner() {
    this.loadingSpinner = wo(), this.innerBox.appendChild(this.loadingSpinner);
  }
  showLoadingSpinner() {
    this.loadingSpinner && (this.hideAllIcons(), this.loadingSpinner.style.opacity = 1);
  }
  createTransitionOverlay() {
    this.transitionOverlay = Co(), this.innerBox.appendChild(this.transitionOverlay);
  }
  ...
  hideHints() {
    !this.hintsOverlay || this.hintsHidden || (this.hintsHidden = !0, ko(this.hintsOverlay));
  }
  addHotspotTimeline() {
    if (!this.hotspots || this.hotspotTimeline) return;
    const t = Po(this.innerBox, this.amountX, this.hotspots);
    if (!t) return;
  ...
  showHotspotTimeline() {
    Ro(this.hotspotTimeline);
  }
  hideHotspotTimeline() {
    Xo(this.hotspotTimeline);
  }
  updateHotspotTimelinePosition() {
    Mo(this.hotspotTimelineIndicator, this.activeImageX, this.amountX);
  }
  /**
  ...
  addAllIcons() {
    this.removeLoader(), this.iconsContainer && (this.innerBox.style.cursor = "grab", this.pointerZoom && (this.createTransitionOverlay(), this.addLoadingSpinner()), this.touchDevice || this.addMagnifierIcon(), this.addFullscreenIcon(), this.initialIconShown && this.addInitialIcon(), this.bottomCircle && this.add360ViewCircleIcon());
  }
  showAllIcons() {
  ...
  addEscKeyHandler() {
    this.boundEscHandler = (t) => {
      t.keyCode === 27 && (this.isZoomed ? this.removeZoom() : this.glass && this.removeGlass());
  ...
  createContainers(t) {
    if (this.iconsContainer = Ae(this.innerBox), this.canvas = uo(this.innerBox, t), this.loader = bo(this.innerBox), this.ariaLiveRegion = xo(this.innerBox), this.useMainThreadCanvas)
      this.canvasWorker.postMessage({
        action: "initCanvas",
  ...
  init(t, i, o) {
    const s = i ? qi(i) : Ui(t), {
      ...
      onProductClick: mi,
      onError: fi
    } = s, pe = { ciToken: A, ciFilters: L, ciTransformation: X, cropAspectRatio: Gt, cropGravity: _t }, qt = oe(h, []), Jt = oe(c, []);
    if (this.viewerConfig = s, this.amountX = qt.length || f, this.amountY = Jt.length || m, this.allowSpinX = !!this.amountX, this.allowSpinY = !!this.amountY, this.activeImageX = y ? this.amountX - 1 : 0, this.activeImageY = y ? this.amountY - 1 : 0, this.bottomCircleOffset = E, this.autoplay = w, this.autoplayBehavior = g, this.playOnce = O, this.speed = p, this.autoplayReverse = y, this.fullscreen = I, this.magnifier = k > 1 ? Math.min(k, _i) : 0, this.dragSpeed = Math.max(j, Gi), this.stopAtEdges = G, this.ciParams = pe, this.apiVersion = l, this.pointerZoom = P > 1 ? Math.min(P, Oe) : null, this.pointerZoomTrigger = D, this.keysReverse = x, this.info = st, this.keys = v, this.innerBox = this.innerBox ?? vo(this.container), this.container.style.aspectRatio = Lt || "", this.initialIconShown = _, this.bottomCircle = nt, this.spinDirection = Ko(this.autoplayBehavior, this.allowSpinX, this.allowSpinY), this.dragReverse = rt, this.hotspots = vt, this.hotspotTrigger = tt, this.onHotspotOpen = Ht, this.onHotspotClose = Zt, this.onProductClick = mi, this.hide360Logo = J, this.logoSrc = V, this.inertia = et, this.pinchZoom = at, this.hints = U, this.hotspotTimelineOnClick = jt, lt === "dark" ? this.container.classList.add("ci360-theme-dark") : lt === "light" && this.container.classList.remove("ci360-theme-dark"), this.container.classList.remove("ci360-hotspot-marker-inverted", "ci360-hotspot-marker-brand"), St === "inverted" ? this.container.classList.add("ci360-hotspot-marker-inverted") : St === "brand" && (this.container.classList.add("ci360-hotspot-marker-brand"), ct && this.container.style.setProperty("--ci360-hotspot-brand-color", ct)), this.onReady = Tt, this.onLoad = Pt, this.onSpin = Ut, this.onAutoplayStart = Kt, this.onAutoplayStop = K, this.onFullscreenOpen = ht, this.onFullscreenClose = Mt, this.onZoomIn = Rt, this.onZoomOut = gt, this.onDragStart = Xt, this.onDragEnd = Yt, this.onError = fi, this.srcXConfig = {
      folder: n,
      filename: a,
      imageList: qt,
      container: t,
    ...
    const me = this.container.offsetWidth, fe = this.allowSpinX && !qt.length ? Ct(this.srcXConfig, me) : null, ve = this.allowSpinY && !Jt.length ? Ct(this.srcYConfig, me) : null, ge = (vi) => {
      ke({
        cdnPathX: fe,
        cdnPathY: ve,
        configX: this.srcXConfig,
        configY: this.srcYConfig,
        onImageLoad: (yt, gi, yi) => this.onImageLoad(yt, gi, yi),
        onFirstImageLoad: (yt) => this.onFirstImageLoaded(vi, yt),
...
class An {
  ...
  init(t, i) {
    ...
    t.id || (t.id = o);
    const s = new Je(t, i);
    return this.views.set(o, s), Qe && !this.memoryManagementAutoEnabled && (this.memoryManagementAutoEnabled = !0, setTimeout(() => this.enableMemoryManagement(), 100)), s;
  }
...
//# sourceMappingURL=ci360-C04581P-.mjs.map
