[![Release](https://img.shields.io/badge/release-v2.7.2-blue.svg)](https://github.com/scaleflex/js-cloudimage-360-view/releases)
...
```javascript
<script src="https://cdn.scaleflex.it/plugins/js-cloudimage-360-view/2.7.2/js-cloudimage-360-view.min.js"></script>
```
