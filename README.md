[![Release](https://img.shields.io/badge/release-v2.0.1-blue.svg)](https://github.com/scaleflex/js-cloudimage-360-view/releases)
...
```javascript
<script src="https://cdn.scaleflex.it/filerobot/js-cloudimage-360-view/v2.0.1.min.js"></script>
```
